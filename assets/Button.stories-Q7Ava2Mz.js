import{_ as z}from"./Button-CYivVhGd.js";import{w as _}from"./index-Cr4duuyA.js";import"./vue.esm-bundler-22DNFjOf.js";import"./Icon-kn0Px43-.js";import"./useRouterLink-DK_zrrsf.js";import"./v4-CtRu48qb.js";const D={title:"Components/Button",component:z,argTypes:{prependIcon:{control:"select",options:["local-fire-department-outline","explore-outline"]},appendIcon:{control:"select",options:["local-fire-department-outline","explore-outline"]}}},e={decorators:[_()],render:r=>({components:{Button:z},setup:()=>({args:r}),template:'<Button v-bind="args">Button</Button>'})},t={...e,render:r=>({...e.render(r),template:`
